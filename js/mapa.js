...
(function () {
  ...
  // Preencha WHATSAPP com o número real (só dígitos, com DDI 55) para o botão
  // virar link de WhatsApp. Enquanto vazio, o botão cai no e-mail de contato.
  const WHATSAPP = '';                              // TODO: ex. '5554999998888'
  const EMAIL_CONTATO = 'contato@tropicco.com.br';
  ...
  function ctaCard(nome) {
    ...
    const href = WHATSAPP
      ...
      : `mailto:${EMAIL_CONTATO}?subject=${encodeURIComponent('Quero conhecer ' + nome)}&body=${encodeURIComponent(msg)}`;
    return `<a class="pin-card-cta" href="${href}" target="_blank" rel="noopener">${ICONE_WHATS}Quero conhecer</a>`;
  }
