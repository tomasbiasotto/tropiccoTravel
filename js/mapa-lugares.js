...
window.MAPA_LUGARES = [
  ...
  // ─── BRASIL ────────────────────────────────────────────────────────────────
  {
    ...
    cidades: [
      ...
      // ── Praias do Nordeste ──
      { nome: 'Porto de Galinhas', coords: { lat: -8.5089, lng: -35.0064 },
        desc: 'Piscinas naturais de águas mornas entre os corais — passeio de jangada à vista.', pontos: [] },
      { nome: 'Maragogi', coords: { lat: -9.0122, lng: -35.2225 },
        desc: 'O Caribe brasileiro — galés de águas transparentes a 6 km da costa de Alagoas.', pontos: [] },
      { nome: 'Maceió', coords: { lat: -9.6498, lng: -35.7089 },
        desc: 'A capital de mar verde-esmeralda e jangadas, do Pajuçara a Paripueira.', pontos: [] },
      { nome: 'Praia de Pipa', coords: { lat: -6.2278, lng: -35.0478 },
        desc: 'Falésias, golfinhos na baía e a vida noturna mais charmosa do litoral potiguar.', pontos: [] },
      { nome: 'Morro de São Paulo', coords: { lat: -13.3833, lng: -38.9167 },
        desc: 'Ilha sem carros, de praias numeradas — do mergulho tranquilo à festa na areia.', pontos: [] },
      { nome: 'Praia do Forte', coords: { lat: -12.5797, lng: -38.0008 },
        desc: 'A vila do Projeto Tamar, piscinas naturais e coqueiros — a Bahia elegante.', pontos: [] },
      { nome: 'Trancoso', coords: { lat: -16.5897, lng: -39.0967 },
        desc: 'O Quadrado à beira-mar e praias desertas — o destino mais chique do litoral baiano.', pontos: [] },
      { nome: 'São Miguel dos Milagres', coords: { lat: -9.2700, lng: -35.3800 },
        desc: 'A Rota Ecológica de Alagoas — recifes, peixe-boi e pousadas pé na areia.', pontos: [] },
      { nome: 'Praia dos Carneiros', coords: { lat: -8.7042, lng: -35.1308 },
        desc: 'A capelinha à beira-mar e o rio que encontra o oceano entre coqueiros.', pontos: [] },
      { nome: 'Genipabu', coords: { lat: -5.6500, lng: -35.1200 },
        desc: 'Dunas gigantes para descer de buggy direto no mar, nos arredores de Natal.', pontos: [] },
      { nome: 'Canoa Quebrada', coords: { lat: -4.5167, lng: -37.7000 },
        desc: 'Falésias vermelhas, kitesurfe e a boemia da Broadway cearense.', pontos: [] },
      { nome: 'Barra Grande', coords: { lat: -14.1700, lng: -38.9600 },
        desc: 'A ponta da península de Maraú — piscinas naturais e o mar de duas cores.', pontos: [] },
    ]
  },
